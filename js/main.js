        ...
        $('#nameBtn').click(
            function(){
                ...
                if(validator.element( "#name" )){
                    ...
                    $('#nameText').parent().find('small').html('You can call me <span class="typist sp-elite blue"></span>').before('<br/>');
                    
                    $('.typist').typed({ strings: ["b3457m0d3"], typeSpeed: 50 });
                    ...
                    $('#rightPanel').animate({ width: [ 350, "swing" ], opacity: 1 }, 2000, "linear", function(){ $('#to2').fadeIn("slow").removeClass('hide'); });
